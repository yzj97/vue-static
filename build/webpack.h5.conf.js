...
let modulePath = `h5/`
let filename = utils.assetsPath(`${modulePath}js/h5_cms.js`)
...
const webpackConfig = merge(baseWebpackConfig, {
  mode: 'production',
  entry: {
    main: `./src/cms/h5-components/main.js`
  },
  module: {
  ...
  output: {
    ...
    library: poolName,
    filename,
    chunkFilename: utils.assetsPath(`${modulePath}js/h5_cms.js`)
  },
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: utils.assetsPath(`${modulePath}css/h5_cms.css`),
      chunkFilename: utils.assetsPath(`${modulePath}css/h5_cms.css`)
    }),
