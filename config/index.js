...
module.exports = {
  dev: {
    ...
    proxyTable: {
      // '/socketServer': {
      //   target: 'ws://' + userConfig.BASE_API.split("//")[1],
      //   ws: true,
      //   secure: false,
      //   logLevel: 'debug',
      // },
      '/api/ody-project-demo': {
        target: 'http://192.168.20.100:8088',
        changeOrigin: true,
        pathRewrite: { '^/api/ody-project-demo': '/ody-project-demo' },
      },
      '/api': {
        target: userConfig.BASE_API,
        changeOrigin: true,
        pathRewrite: { '^/api': '' },
        secure: false,
  ...
  build: {
    ...
    // js
    jsAssetsRoot: path.resolve(__dirname, '../dist-js'),
