<template>
  <div class="cp-cms-goods">
    ...
    <div v-if="!isLast && total > pageSize && !isRecommend" class="load-more">
      <a :href="baseConfig.isEdit ? 'javascript:void(0)' : isRecommend ? '/recommond-goods.html' : '/search.html?cmsModuleId=' + itemData.id" class="load-more__btn">
    ...
    <div v-if="listObj.length === 0 && baseConfig.isEdit" class="goods-list">
      <div v-for="item in 2" :key="item" class="goods-item">
        <div class="goods-img">
