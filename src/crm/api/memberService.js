export default {
  ...
  queryRedevMemberInfoList: { // 查询会员列表
    url: 'ouser-web/redevUser/member/queryMemberList.do',
    method: 'post'
  },
  queryMemberInfoListAuth: { // 查询会员列表
    url: 'ouser-web/member/queryMemberListAuth.do',
    method: 'post'
  },
  updateStatus: { // 修改状态
  ...
  memberAsyncExportAuth: {
    url: 'ouser-web/member/asyncExportAuth.do',
    method: 'post'
  },
  downloadTask: {
