    ...
    >
      <el-row>
        <el-col :span="5">
          <el-form-item>
            <el-checkbox
              slot="label"
              v-model="paramJson.birthdayOn"
              name="paramJson_birthdayOn"
              @change="onSwitchChange">{{ $t('会员生日回馈') }}
            </el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="4">
        ...
        <el-col :span="12">
          <el-form-item prop="typeForBirthDay">
            <el-radio
              v-model="paramJson.typeForBirthDay"
              :label="1"
              name="paramJson_typeForBirthDay1"
              @change="onTypeForBirthDayChange">{{ $t('按月') }}
            </el-radio>
          </el-form-item>
        </el-col>
      </el-row>
        ...
        <el-col :span="12" :offset="9">
          <el-form-item>
            <el-radio
              v-model="paramJson.typeForBirthDay"
              :label="2"
              name="paramJson_typeForBirthDay2"
              @change="onTypeForBirthDayChange">{{ $t('按天') }}
            </el-radio>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="10">
          <el-form-item prop="valueForBirthday">
            <el-input-number
              :placeholder="$t('最多10位正整数位')"
              v-model="paramJson.valueForBirthday"
              :controls="false"
              :precision="0"
              :max="maxAmount"
              name="paramJson_valueForBirthday"
              style="width:200px;"/>
            {{ $t('倍积分') }}
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="5">
          <el-form-item>
            <el-checkbox
              slot="label"
              v-model="paramJson.periodicOn"
              name="paramJson_periodicOn"
              @change="onSwitchChange">{{ $t('周期性消费回馈') + ':' }}
            </el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="4">
        ...
        <el-col :span="12">
          <el-form-item prop="periodType">
            <el-radio
              v-model="paramJson.periodType"
              :label="1"
              name="paramJson_periodType"
              @change="onPeriodTypeChange">{{ $t('按周') }}
            </el-radio>
            {{ $t('each') }}
        ...
        <el-col :span="12" :offset="9">
          <el-form-item>
            <el-radio
              v-model="paramJson.periodType"
              :label="2"
              name="paramJson_periodType5"
              @change="onPeriodTypeChange">{{ $t('按月') }}
            </el-radio>
            {{ $t('每个月的') }}
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="valueForPeriodic">
            <el-input-number
              :placeholder="$t('最多10位正整数位')"
              v-model="paramJson.valueForPeriodic"
              :controls="false"
              :precision="0"
              :max="maxAmount"
              name="paramJson_valueForPeriodic"
              style="width:200px;"/>
            {{ $t('倍积分') }}
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="5">
          <el-form-item>
            <el-checkbox
              slot="label"
              v-model="paramJson.appointedOn"
              name="paramJson_appointedOn"
              @change="onSwitchChange">{{ $t('定时性消费回馈') + ':' }}
            </el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="4">
        ...
        <el-col :span="8">
          <el-form-item prop="appointedDate">
            <el-date-picker
              :placeholder="$t('请选择') + $t('date,')"
              :picker-options="periodDatePickerOptions"
              v-model="paramJson.appointedDate"
              name="paramJson_appointedDate"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="valueForAppointed">
            <el-input-number
              :placeholder="$t('最多10位正整数位')"
              v-model="paramJson.valueForAppointed"
              :controls="false"
              :precision="0"
              :max="maxAmount"
              name="paramJson_valueForAppointed"
              style="width:200px;"/>
            {{ $t('倍积分') }}
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col>
          <el-form-item>
            <el-checkbox
              v-model="paramJson.meantimeTriggerOn"
              :label="$t('是否同时触发')"
              name="paramJson_meantimeTriggerOn"/>
...
export default {
  ...
  mounted() {
    ...
    if (!this.paramJson.typeForBirthDay) {
      this.paramJson.typeForBirthDay = 1
    }
  ...
  methods: {
    ...
    validateData() {
      ...
      if (!this.paramJson.channelCodes || this.paramJson.channelCodes.length === 0) {
        this.$message.info(this.$t('请选择渠道'))
        console.log('aaaaa')
        return false
      }
      return true
