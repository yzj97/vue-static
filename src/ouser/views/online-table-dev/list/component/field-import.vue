<template>
  <ody-list-table-area>
    <div slot="btn">
      ...
      <el-button name="ui_syncEditFields" code="ui" size="small" type="primary" @click="syncEditFields">同步编辑字段</el-button>
      <el-switch v-model="importAsync" name="importAsync" code="ui" @change="$emit('update:importAsync', importAsync)"/>是否异步导入
    </div>
    <div slot="table">
      <ody-table
        v-loading="loading"
...
export default {
  ...
  props: {
    ...
    importAsync: { type: Boolean, default: false },
