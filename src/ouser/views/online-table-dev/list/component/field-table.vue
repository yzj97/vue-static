<template>
  <ody-list-table-area>
    <div slot="btn">
      ...
      <el-switch v-model="showCheckbox" name="showCheckbox" code="ui" @change="$emit('update:showCheckbox', showCheckbox)"/>表格是否显示复选框
      <el-switch v-model="isPagination" name="isPagination" code="ui" @change="$emit('update:isPagination', isPagination)"/>是否支持分页
    </div>
    <div slot="table">
      <ody-table
        v-loading="loading"
