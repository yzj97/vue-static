...
export default {
  ...
  methods: {
    changeClassification() {
      this.showClassificationTree = false
      this.$nextTick(() => {
        this.showClassificationTree = true
      })
    },
    changeSupplierClass(node) {
      this.supplierClassification = node || {}
    }
  }
}
</script>
