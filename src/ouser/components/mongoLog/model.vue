      ...
      <ody-list-search-area>
        <div slot="content">
          <el-form ref="form" label-width="100px" class="form">
            ...
            <ody-search-item label="TableName:" prop="tableName">
              <el-input v-model="searchForm.tableName" name="searchForm_tableName" placeholder="表名"/>
            </ody-search-item>
...
export default {
  ...
  methods: {
    ...
    findMongoLog(checkNo) {
      ...
      const self = this
      mongoLogService.model(this.buildRequestData()).then(res => {
        const data = res.data || []
    ...
    buildRequestData() {
      ...
      const extensionQuery = {
        ...
        tableName: this.searchForm.tableName ? this.searchForm.tableName : null,
        likeOrEqMap: {}
      }
      let modelId = null
