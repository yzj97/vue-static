  ...
  <div class="supplier-edit-financial-info">
    ...
    <div class="tax-information">
      ...
      >
        ...
        >
          <ody-supplier-choose v-model="basicInfo.paymentSupplierCode" name="basicInfo_paymentSupplierCode" placeholder="请选择" />
        </el-form-item>
        ...
        >
          <ody-supplier-choose v-model="basicInfo.deliverySupplierCode" name="basicInfo_deliverySupplierCode" placeholder="请选择" />
        </el-form-item>
      </el-form>
    </div>
  </div>
