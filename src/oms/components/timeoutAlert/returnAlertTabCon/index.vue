  ...
  data() {
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            const to = {
              ...
              params: {
                id: params.row.extInfo.returnId
              }
            }
            return (
              <router-link to={to} class='link-type'>
                <span>{ params.row.refId}</span>
              </router-link>
            )
          }
        },
        ...
        {
          'show': true,
          'label': this.$t('timeoutAlertReturnCreateTime'),
          'align': 'center',
          'minWidth': 200,
          render: (h, params) => {
            return (<span>{params.row.extInfo.returnCreateTime}</span>)
          }
        },
        {
          'show': true,
