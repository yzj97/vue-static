  ...
  <section class="pg-apSupplierInvoice-list">
    <ody-list-search-area>
      ...
      <div slot="btn">
        ...
        <ody-button name="InventoryMwaCostSummaryList_handleSearchSubmit" code="InventoryMwaCostSummaryList" size="small" type="primary" @click="handleSearchSubmit">{{ $t('common_select') }}</ody-button>
      </div>
    </ody-list-search-area>
    <ody-list-table-area>
      <div slot="btn-bottom">
        <ody-button name="InventoryMwaCostSummaryExport_exportFinInventoryMwaCost" code="InventoryMwaCostSummaryExport" size="small" @click="exportFinInventoryMwaCost">{{ $t('common_export') }}</ody-button>
      </div>
      <div slot="table">
        <ody-table
          :loading="loading"
...
export default {
  ...
  methods: {
    ...
    exportFinInventoryMwaCost() {
      ...
      this.$portal.downloadFileByPost('/api/back-finance-web/finInventoryMwaCostController/exportFinInventoryMwaCostSummaryList.do', filters)
    }
  }
}
async function loadList(vue) {
  ...
  const res = await finInventoryMwaCost.listSummaryFinInventoryMwaCostPage(param)
  if (res) {
    const data = res
    vue.list = data.data
