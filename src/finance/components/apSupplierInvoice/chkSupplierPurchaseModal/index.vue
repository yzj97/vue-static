          ...
          <div slot="content">
            <el-form ref="form" label-width="50px" class="form">
              ...
              <ody-search-item :label="$t('settle_obj_name')" prop="settleObjName">
                <el-input v-model="searchForm.settleObjName" name="searchForm_settleObjName" />
              </ody-search-item>
        ...
        <ody-list-table-area>
          <div slot="table">
            ...
            >
              ...
              <el-table-column :label="$t('settle_obj_code')" align="center" prop="settleObjCode" />
              <el-table-column :label="$t('settle_obj_name')" align="center" prop="settleObjName" />
