...
<script>
import FullNumPromotionStep1 from '@/components/full-num-promotion-step1'
        ...
        this.$refs.singlePromotionStep1.$refs.singlePromotion.validate(
          (valid, object) => {
            if (valid && canSave) {
              ...
              params.conditionType = 2
              params.fromDate = createTimeStart
              params.endDate = createTimeEnd

              // 活动渠道是否勾选京东到家
              var channelCode = this.channelCodes.indexOf('210004')
              if (channelCode === 1) {
