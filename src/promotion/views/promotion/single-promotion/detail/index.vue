        ...
        <el-tab-pane :label="$t('促销规则')" name="first" class="promotion-rules">
          <ody-space :space="4">
            ...
            <div class="base-info">
              ...
              <div class="item">
                <label>{{ $t('活动类型') }}：</label>
                {{ detailData.promotionMethod | keyVal(getPromotionMethodList) }}
              </div>
              <div class="item">
                <label>{{ $t('活动形式') }}：</label>
            ...
            <div class="base-info">
              ...
              <div v-show="platformId != 2" class="item">
...
export default {
  ...
  methods: {
    ...
    viewMarketingReport() {
      // const url = `obi-web/#/activityEffectAnalysis?promotionId=${this.promotionId}`
      // window.open(url)
      this.$router.push({
