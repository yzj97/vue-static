  ...
  <div class="pg-promotion-detail">
    <ody-box :title="$t('促销活动详情')">
      ...
      <el-tabs v-model="activeName" name="activeName" @tab-click="handleTabClick">
        <el-tab-pane :label="$t('促销规则')" name="first" class="promotion-rules">
          <ody-space :space="4">
            ...
            <div class="base-info">
              ...
              <div class="item">
                <label>{{ $t('活动类型') }}：</label>
                {{ detailData.conditionType | keyVal(getConditionType) }}
              </div>
              <!-- <div class="item">
                <label>活动形式：</label>
        ...
        <el-tab-pane :label="$t('换购商品')" name="fourth">
          <ody-list-table-area>
            <div slot="table">
              <ody-table
                :data="giftTable.data"
  ...
  methods: {
    ...
    async queryPromotionActivityDetail() {
      ...
      if (code === '0' && data) {
        ...
        console.log(this.detailData, 444)
