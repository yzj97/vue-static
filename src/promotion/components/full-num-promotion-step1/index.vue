      ...
      <div class="single-promotion-content">
        ...
        <el-form-item
          ...
          <ody-radio2
            ...
            list-key="promotionNumMethodList"
...
export default {
  ...
  watch: {
    ...
    'singlePromotion.channelCodes': function(val) {
      if (val) {
        this.$emit('channelCodes', val)
      }
    },
    'singlePromotion': {
  ...
  methods: {
    ...
    buildFrontPromDesc() {
      ...
      if (params.promotionType === 3 && params.promotionMethod === 3) {
        params.favourableList.forEach(f => {
          if (f.favourableCondition) {
            f.favourableCondition = +f.favourableCondition
          }

          if (f.favourableContent) {
            f.favourableContent = f.favourableContent * 100
          }
        })
      }
      if (params.promotionType === 3 && params.promotionMethod === 2) {
        params.favourableList.forEach(f => {
          if (f.favourableCondition) {
            f.favourableCondition = +f.favourableCondition
          }
    ...
    async queryPromotionActivityDetail() {
      ...
      if (code === '0') {
        ...
        console.log(this.singlePromotion.favourableList, 99999)
