        ...
        <el-row>
          <el-col span="22" offset="1">
            <el-form-item :label="$t('联系人名称')" prop="name">
              <el-input v-model="addSupplierContact.name" name="addSupplierContact_name" maxlength="100" />
            </el-form-item>
            <el-form-item :label="$t('性别')" prop="sex">
              <ody-radio2 v-model="addSupplierContact.sex" name="addSupplierContact_sex" list-key="sexList" />
            </el-form-item>
            <el-form-item :label="$t('联系人职位名称')" prop="position">
              <el-input v-model="addSupplierContact.position" name="addSupplierContact_position" maxlength="50" />
            </el-form-item>
            <el-form-item :label="$t('手机号码')" prop="mobileNo">
              <el-input v-model="addSupplierContact.mobileNo" name="addSupplierContact_mobileNo" maxlength="50" />
            </el-form-item>
            <el-form-item :label="$t('固定电话')" prop="telNo">
              <el-input v-model="addSupplierContact.telNo" name="addSupplierContact_telNo" maxlength="50" />
            </el-form-item>
            <el-form-item :label="$t('传真')" prop="fax">
              <el-input v-model="addSupplierContact.fax" name="addSupplierContact_fax" maxlength="20" />
            </el-form-item>
            <el-form-item :label="$t('QQ')" prop="qq">
              <el-input v-model="addSupplierContact.qq" name="addSupplierContact_qq" maxlength="50" />
            </el-form-item>
            <el-form-item :label="$t('微信')" prop="weixin">
              <el-input v-model="addSupplierContact.weixin" name="addSupplierContact_weixin" maxlength="20" />
            </el-form-item>
            <el-form-item :label="$t('联系邮箱')" prop="email">
              <el-input v-model="addSupplierContact.email" name="addSupplierContact_email" maxlength="50" />
            </el-form-item>
            ...
            <el-form-item :label="$t('主要联系人')" prop="isMain">
              <ody-select2 v-model="addSupplierContact.isMain" name="addSupplierContact_isMain" list-key="mainList" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        if (!this.isAdd) {
          await this.$opms.$api.supplier.saveOrUpdateMerchantOrgContact(params)
