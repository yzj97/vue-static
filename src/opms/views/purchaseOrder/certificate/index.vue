<template>
  <section class="context">
    ...
    <div v-show="!isFlag">
      ...
      <ody-button
        name="OpmsPurchaseOrderList20_auditorDialog"
        type="primary"
        size="small"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <ody-button name="OpmsPurchaseOrderList21_doAuditor" code="OpmsPurchaseOrderList11" @click="doAuditor(0)">{{ $t('notpass') }}</ody-button>
        <ody-button
          name="OpmsPurchaseOrderList22_doAuditor"
          type="primary"
          code="OpmsPurchaseOrderList11"
          @click="doAuditor(1)"
        >{{ $t('pass') }}</ody-button>
    ...
    <ody-dialog :visible.sync="dialogFormVisible" :title="$t('common_edit')" width="650px">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <ody-button
          name="OpmsPurchaseOrderList23_dialogFormHandle"
          type="primary"
          code="OpmsPurchaseOrderList11"
  ...
  methods: {
    ...
    doAuditor(auditorStatus) {
      ...
      if (list.length > 0) {
        ...
        purchasePlan
          .updateOrderProductCertificateAuditorStatus({ list: list })
          .then(data => {
      ...
      if (ok && this.dialogFormVisible) {
        ...
        if (this.form.certificateUrl.length > 0) {
          ...
          data.certificateUrlName =
            this.form.certificateUrl[0]['fileName'] ||
