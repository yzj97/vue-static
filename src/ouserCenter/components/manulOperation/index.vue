    ...
    <section>
      <ody-list-search-area>
        <div slot="content">
          <el-form ref="form" :model="searchForm" label-width="100px" class="form">
            <ody-search-item
              ...
              type="text"
              prop="entityId">
              <el-input v-model="searchForm.entityId" name="searchForm_entityId" />
            </ody-search-item>
            <ody-search-item :label="$t('运营人员')" class="register" prop="createUsername">
              <el-input v-model="searchForm.createUsername" name="searchForm_createUsername" type="text" />
            </ody-search-item>
            <ody-search-item :label="$t('作业类型')" type="text" prop="processType">
              <el-select v-model="searchForm.processType" name="searchForm_processType">
                <el-option
            ...
            <ody-search-item :space="2" :label="$t('operation_time')" type="text" prop="data">
              <ody-date-range-picker v-model="searchForm.data" name="searchForm_data" type="datetimer" />
            </ody-search-item>
            <ody-search-item :label="$t('作业状态')" type="text" prop="auditStatus">
              <el-select v-model="searchForm.auditStatus" name="searchForm_auditStatus">
                <el-option
        ...
        <div slot="btn">
          ...
          <ody-button
            :code="type === 2 ? 'GrowthManualOperationQuery' : 'ManualOperationQuery'"
          ...
          <el-col :span="2">
            <div>
              <ody-button
                ...
                :code="type === 2 ? 'GrowthManualOperationBatchAudit' : 'ManualOperationBatchAudit'"
                name="batchAudit"
                size="small"
                type="primary"
                @click="batchAudit()"
...
async function loadList(vue) {
  ...
  vue.searchForm.param.entityId = vue.searchForm.entityId
  ...
  const op = vue.$ouserCenter.$api.crmService.listPointLogPage(param)
  return op.then(res => {
    if (res.code === '0') {
